...
////
procedure crearArchivoDesdeTexto(var archivo: tipoArchVoto);
var
  registro: tipoVoto;
  textoEncuesta: text;
begin
  assign(textoEncuesta,'D:\facu\fod2017\scr\EnunciadoFOD2017Ejercicio2TextoEncuesta.txt');
  reset(textoEncuesta);
...
BEGIN {programa principal}
  assign(archivo,'D:\facu\fod2017\scr\EnunciadoFOD2017Ejercicio2TextoEncuesta');
  rewrite(archivo);
  crearArchivoDesdeTexto(archivo);
