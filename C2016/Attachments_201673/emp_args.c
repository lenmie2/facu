...
void usage(char *argv[], int code)
{
 ...
 printf("       %s {--repack|-r} <list of files> {--output|-o} file.emp \n",argv[0]);
 printf("       %s {--unpack|-u} <list of files> {--input|-i} file.emp [--outputdir|-t dir] \n",argv[0]);
 printf("       %s {--unpackall|-a}              {--input|-i} file.emp [--outputdir|-t dir] \n",argv[0]);
 printf("       %s {--list|-l}  [name|date|size] {--input|-i} file.emp \n",argv[0]);
 printf("       %s {--detail|-d} <file>          {--input|-i} file.emp \n",argv[0]);
 exit(code);
}
