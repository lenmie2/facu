...
emp_file_hd_t* init_file_arr(FILE* emp); //Inicializador de arreglo de headerFile

emp_file_hd_t search_file_arr(const char *path, emp_file_hd_t* arrHeader,int entries); //Busca determinado headerFile

int search_file(const char *path,FILE *emp,emp_file_hd_t* headerFile); //Posiciona el puntero en determinado archivo
