...
-Alumnos: S. Encinas Javier DNI: 37021340 // Milagros Rucci LEG: 13995/7
  ...
  ESTADO DE LA APLICACION
    ...
    Operaciones:
      ...
      *- repack: NO FUNCIONAL
      *- unpack: NO FUNCIONAL
      *- unpack-all: FUNCIONAL - le falta implentar logica para desempaquetar en direcciones
      *- list: NO FUNCIONAL
      *- detail: NO FUNCIONAL
...
//endtesto
  ...
  else if ( (flagOP.a == 1) && (flagIO.i == 0) && (flagIO.o == 0) ){  //cambiar el valor de las flags cuando se le implemente el outdir
    emp_uapack(buffer);}
/*
